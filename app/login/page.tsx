  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      try {
        ...
        // Fallback to redirect login if popup blocked
        if (
          authError.code === 'auth/popup-blocked' ||
          authError.code === 'auth/cancelled-popup-request'
        ) {
          console.log('Popup blocked. Switching to redirect login.')
      ...
      if (err && typeof err === 'object' && 'code' in err) {
        ...
        switch (firebaseError.code) {
          ...
          case 'auth/invalid-api-key':
            errorMessage =
              'Invalid Firebase API key. Check your environment variables.'
            break
          ...
          >
            {isDark ? (
              ...
              >
                <path
                  fillRule="evenodd"
                  d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4.22 1.78a1 1 0 011.414 0l.707.707a1 1 0 01-1.414 1.414l-.707-.707a1 1 0 010-1.414z"
                  clipRule="evenodd"
                />
              </svg>
            ) : (
